json.extract! @user, :email, :first_name, :last_name, :username, :dob, :class_of, :year_text, :school_id, :created_at, :followed_schools, :updated_at, :is_private, :is_location_private, :longitude, :latitude
